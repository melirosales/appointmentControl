...
namespace appointmentControl.Backend.WepApi
{
    ...
    public class PatientController : Controller
    {
        ...
        public PatientController(IConfiguration iConfiguration)
        {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List([FromBody] Model.Patient model)
        {
            try
            {
                ...
                using (var businessLgic = new DoWorkService())
                {
                    ...
                    var list = result.DeSerializeObject<IEnumerable<Model.Patient>>(); 
                    return Ok(list);
                }
            }
            catch (Exception ex)
        ...
        [Route("Get")]
        [HttpPost]
        public async Task<IActionResult> Get([FromBody] Model.Patient model)
        {
            try
            {
                var message = new Message();
